...
export default function AdaptiveShield({ initialState }: Props) {
  const [activeRules, setActiveRules] = useState<Record<string, boolean>>(initialState)
